...
class BevformerPointPillarDisconet(BaseCameraLiDARIntermediate):
    def __init__(self, config):
        super(BevformerPointPillarDisconet, self).__init__(config)
    ...
    def forward(self, batch):
        ...
        # B, L, C, H, W
        x = self.fusion_net(x, mask, record_len, pairwise_t_matrix, None)
