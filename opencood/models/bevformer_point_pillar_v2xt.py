...
class BevformerPointPillarV2XT(BaseCameraLiDARIntermediate):
    def __init__(self, config):
        super(BevformerPointPillarV2XT, self).__init__(config)
    ...
    def forward(self, batch):
        ...
        # B, L, C, H, W
        x = self.fusion_net(x.permute(0, 1, 3, 4, 2), mode, com_mask).squeeze(
            1).permute(0, 3, 1, 2)
