...
from opencood.models.fusion_modules.f_cooper_fuse import SpatialMaxFusion
...
class FaxPointPillarFcooper(BaseCameraLiDARIntermediate):
    def __init__(self, config):
        super(FaxPointPillarFcooper, self).__init__(config)
        ...
        self.fusion_net = SpatialMaxFusion()
